...
//            Login.idCus;
            ...
            String sql ="UPDATE `ex_customer` SET `ct_name`='"+edtname.getText ().toString ()+"',`ct_lastname`='"+edtlastname.getText ().toString ()+"',`ct_password`='"+edtpasswordAfterAgin.getText ().toString ()+"',`ct_phone`='"+edtphone.getText ().toString ()+"' WHERE ct_id = '"+Login.idCus+"'\n";
...
//            Login.idCus;
            ...
            String sql ="UPDATE `ex_customer` SET `ct_name`='"+edtname.getText ().toString ()+"',`ct_lastname`='"+edtlastname.getText ().toString ()+"',`ct_phone`='"+edtphone.getText ().toString ()+"' WHERE ct_id = '"+Login.idCus+"'";
//            "+Login.idCus+"'
             mStmt1.executeUpdate ( sql );
            ResultSet rs=mStmt1.getGeneratedKeys();
            rs.close ();
...
//            "+Login.idCus+"'
            ...
            if (rs1.next ()){
                passBefor=rs1.getString ( "ct_password" );
                edtname.setText (  rs1.getString ( "ct_name" ));
                edtlastname.setText ( rs1.getString ( "ct_lastname" ) );
                edtphone.setText ( rs1.getString ( "ct_phone" ) );
